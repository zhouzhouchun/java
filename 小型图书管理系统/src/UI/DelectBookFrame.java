...
public class DelectBookFrame extends JFrame implements ActionListener{
	JLabel id = null;
	JLabel name = null;
	JLabel author = null;
	JLabel price = null;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==query) {
			...
			if(BookDAO.delectbook(idtxt.getText())==1&&flag==1) {
				System.out.println(flag);
				JOptionPane.showMessageDialog(null, "删除成功");
			}else if(flag==0) {
				JOptionPane.showMessageDialog(null, "请先输入id查询要删除的图书");
			}
			else
